...
results = soup.find_all("span")  # 1000commonwords stores its links containing language names in spans
...
for language_name in language_names:
    try:
        ...
        langURL = "https://1000mostcommonwords.com/1000-most-common-" + language_name.lower() + "-words/"
